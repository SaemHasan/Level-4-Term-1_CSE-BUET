...
def print3DArrayHex(array):
    for i in range(len(array)):
        print("round : ", i)
        print2DArrayHex(array[i])
        print()


def print2DArrayHex(array):
    for row in array:
        printArrayHex(row)
    print()


def printArrayHex(row):
    for v in row:
        a = hex(v)
        a = str(a)
        a = a[2:]
...
def array1Dto2D(array):
    return np.array([array[i:i+4] for i in range(0, len(array), 4)]).transpose()
